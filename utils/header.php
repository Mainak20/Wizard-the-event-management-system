    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Wizard:- The Event Management Systems</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                Whether you're looking to book a cocktail party, post-work gathering, celebratory function, conference, business
                meeting, wedding or private dining event, our dedicated Wizard team can create a package that will meet
                your every need.
                </p>                                                                 
                <p id="dateAndTime"></p>
            </div>
